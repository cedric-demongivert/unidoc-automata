import { UTF32CodeUnit, UTF32String, UnidocEvent, UnidocEventType } from '@cedric-demongivert/unidoc'
import { UnidocAutomata } from './UnidocAutomata'
...
export class UnidocUTF32TextBuilder {
   ...
   * 
   */
  @UnidocAutomata.words('everything')
   ...
   * 
   */
  @UnidocAutomata.whitespaces('everything')
